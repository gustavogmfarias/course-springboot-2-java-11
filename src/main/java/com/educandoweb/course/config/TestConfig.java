...
public class TestConfig implements CommandLineRunner { // nesse teste tem que implementar a command line runner para ela
	...
	public void run(String... args) throws Exception {
		...
		p1.getCategories().add(cat2); //faço a associação entre o produto e a categoria
		...
		productRepository.saveAll(Arrays.asList(p1,p2,p3,p4,p5)); //salvo novamente para colocar no bd relacionar
